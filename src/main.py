...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_date", type=str, default=(datetime.today() - timedelta(days=365*10)).strftime("%Y-%m-%d"), help="Start date for historical data.")
    parser.add_argument("--end_date", type=str, default=datetime.today().strftime("%Y-%m-%d"), help="End date for historical data.")
    parser.add_argument("--horizon", type=int, default=20, help="Forecast horizon in days.")
    parser.add_argument("--model_type", type=str, default="rf", choices=["rf", "xgb", "lstm"], help="Model type: 'rf' (Random Forest), 'xgb' (XGBoost), 'lstm' (LSTM).")
    parser.add_argument("--forecast_steps", type=int, default=0, help="Number of forward forecast steps (0 for no forecasting).")
